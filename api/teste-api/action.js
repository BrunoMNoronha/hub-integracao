import { executeAction } from '../../lib/teste-api/client.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (error instanceof ModuleError) {
      console.warn(`[teste-api-action] Erro de Módulo (HTTP ${error.statusCode}): ${error.message}`);
    ...
    console.error('[teste-api-action] Erro interno inesperado:', error.message, error.stack);
